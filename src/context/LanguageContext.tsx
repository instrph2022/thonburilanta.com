...
const translations = {
  en: {
    ...
    expectStep3Desc: "On-site pharmacy and clinical treatment rooms ensure most patient visits are resolved in a single stop.",
    ...
    expectPill2: "On-Call Standby Doctor",
    expectPill3: "English Medical Reports",
    expectPill4: "Emergency Pharmacy (On-Call)",
  ...
  th: {
    ...
    expectStep3Desc: "บริการตรวจรักษาและจัดจ่ายยามาตรฐานสากล ช่วยดูแลรักษาผู้ป่วยจนเสร็จสิ้นขั้นตอนในที่เดียว",
    ...
    expectPill2: "มีแพทย์สแตนด์บาย On-Call",
    expectPill3: "รายงานการรักษาภาษาอังกฤษ",
    expectPill4: "จ่ายยาฉุกเฉินตลอด 24 ชม. (On-call)",
